...
class UserManagementFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.new_user_entry = ctk.CTkEntry(self.add_box, placeholder_text="Nome de Usuário", width=200, corner_radius=0)
        self.new_user_entry.grid(row=1, column=0, padx=20, pady=10, sticky="w")
        
        self.new_pass_entry = ctk.CTkEntry(self.add_box, placeholder_text="Senha", show="*", width=200, corner_radius=0)
        self.new_pass_entry.grid(row=1, column=1, padx=10, pady=10, sticky="w")
        
        self.add_btn = ctk.CTkButton(self.add_box, text="Cadastrar", command=self.add_user_event, corner_radius=0, width=120)
        self.add_btn.grid(row=1, column=2, padx=20, pady=10, sticky="w")
    ...
    def add_user_event(self):
        ...
        if database.add_new_user(user, pwd):
